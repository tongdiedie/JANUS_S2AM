...
def main(_run, _config, _log):
    ...
    log_loss = {'total_loss': 0, 'prompt_loss': 0, 'align_loss': 0, 'thresh_loss': 0, 'contrastive_loss': 0, 'foreground_loss': 0, 'hbg_loss': 0}
    ...
    for sub_epoch in range(n_sub_epochs):
        ...
        for _, sample in enumerate(train_loader):
            ...
            loss_out = model(support_images, support_fg_mask, query_images, query_labels, True)
            ...
            if (i_iter + 1) % _config['print_interval'] == 0:
                ...
                foreground_loss_avg = log_loss['foreground_loss'] / _config['print_interval']
                ...
                _log.info(f'step {i_iter + 1}: total_loss: {total_loss}, prompt_loss: {prompt_loss}, contrastive_loss: {contrastive_loss}, foreground_loss: {foreground_loss_avg}, hbg_loss: {hbg_loss_avg}')
