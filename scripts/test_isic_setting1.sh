...
do
    ...
    do
      ...
      RELOAD_MODEL_PATH=".../exps_train_on_isic_setting1_FSMIS_FoB/FSMIS_train_isic_setting1_cv${EVAL_FOLD}/1/snapshots/39000.pth"
      python3 test.py with \
      mode="test" \
      dataset=$DATASET \
      isic_setting=$ISIC_SETTING \
      num_workers=$NWORKER \
      n_steps=$NSTEP \
      eval_fold=$EVAL_FOLD \
