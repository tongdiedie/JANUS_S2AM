...
# ============================================================
# JANUS-S2AM training script: train_CHAOST2_full.sh
#
# Usage:
#   bash scripts/janus/train_CHAOST2_full.sh
#   FOLD=0 bash scripts/janus/train_CHAOST2_full.sh
#   FOLDS="0 3 4" bash scripts/janus/train_CHAOST2_full.sh
#   FOLD=0 N_STEPS=1000 bash scripts/janus/train_CHAOST2_full.sh
# ============================================================
...
LOGDIR=${LOGDIR:-./runs_janus/train_CHAOST2_full}
