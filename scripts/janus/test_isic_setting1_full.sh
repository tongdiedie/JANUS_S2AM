...
# ============================================================
# JANUS-S2AM testing script: test_isic_setting1_full.sh
#
# Usage:
#   RELOAD_MODEL_PATH=/path/to/model.pth bash scripts/janus/test_isic_setting1_full.sh
#   FOLD=2 RELOAD_MODEL_PATH=/path/to/model.pth bash scripts/janus/test_isic_setting1_full.sh
#   FOLDS="0 3" RELOAD_MODEL_PATH=/path/to/model.pth bash scripts/janus/test_isic_setting1_full.sh
#   FOLD=0 SUPP_IDX=2 RELOAD_MODEL_PATH=/path/to/model.pth bash scripts/janus/test_isic_setting1_full.sh
# ============================================================
